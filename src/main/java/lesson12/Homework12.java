...
public class Homework12 {
    ...
    private static void testSendKeys(ChromeDriver driver) {
        driver.get("http://training.skillo-bg.com:4300/posts/all");
        WebElement loginLink = driver.findElement(By.id("nav-link-login"));
        loginLink.click();
    ...
    private static void testCommonCommands(ChromeDriver driver) {
        driver.get("http://training.skillo-bg.com:4300/posts/all");
    ...
    private static void testDropdowns(ChromeDriver driver) {
